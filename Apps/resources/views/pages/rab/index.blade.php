...
{{--                    <span class="kt-subheader__breadcrumbs-separator"></span>--}}
                    <a href="javascript:;" class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">Rencana Anggaran Biaya</a>
{{--                    <span class="kt-subheader__breadcrumbs-separator"></span>--}}
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a href="{{ route('rab.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <div class="kt-portlet__body">
                <table class="table table-bordered table-striped" id="dataTable">
                    <thead>
                        <tr>
                            <th style="width: 5%;">#</th>
                            <th style="width: 10%">Nomor SPPD</th>
                            <th>Maksud</th>
                            <th style="width: 15%">Nama</th>
                            <th style="width: 10%">Level Biaya</th>
